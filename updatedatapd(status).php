...
echo "UPDATE `production_plan(erp)1` SET `Status` = '$status' WHERE `JOB` = '$job' ";
   $result = mysqli_query($con, "UPDATE `production_plan(erp)1` SET `Status` = '$status' WHERE `JOB` = '$job'");
   $result1 = mysqli_query($con3, "UPDATE `production_plan(erp)1` SET `Status` = '$status' WHERE `JOB` = '$job'");
?>