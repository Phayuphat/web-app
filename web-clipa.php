...
<div class="col-md-12 ">
	<div class="row">
		...
		<div class="card-header col-md-5 pt-3  text-center ">
			<div class="topic">
			<h1 class="p-3"><B>Clip A F/G</B></h1>
			</div>
		</div>
...
<div class="col-md-12">
	<div class="row">
		...
		<div class="card-header col-md-5 pt-3  text-center ">
			<div class="topic">
			<h1 class="p-3"><B>Clip A WIP</B></h1>
			</div>
		</div>
</div>		
</div>
...
<!--วันที่เวลา-->
	...
	var xmlhttp33 = new XMLHttpRequest();
		...
		xmlhttp33.open("GET", "table-A-FG-mainpage2.php?machine=1", true);
		 xmlhttp33.send();
	...
	var xmlhttp33 = new XMLHttpRequest();
		...
		xmlhttp33.open("GET", "table-A-FG-mainpage2.php?machine=3", true);
		 xmlhttp33.send();
}
